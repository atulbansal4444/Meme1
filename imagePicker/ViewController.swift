...
class ViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextFieldDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        topTextField.defaultTextAttributes = memeTextAttribute    //default styles
        bottomTextField.defaultTextAttributes=memeTextAttribute     //default size
        topTextField.textAlignment = .center  //alignment
        bottomTextField.textAlignment = .center //alignment
